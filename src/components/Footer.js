      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10">
        ...
        <div className="col-span-1 sm:col-span-2 md:col-span-1 flex flex-col gap-4">
          ...
          <div className="flex gap-4 mt-2">
            ...
            <a href="https://wa.me/+994105210909" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <a href="tel:+994102238989" className="flex items-center gap-2 hover:text-brand-400 transition-colors">
                <Icon name="phone" size={16} className="text-brand-500" /> 994 10 223 89 89
              </a>
            </li>
            <li>
